...
public class FilteringBeerMethodReferenceComposing {
    ...
    public static void main(String[] args) {
        ...
        Predicate<Beer> fromBelgium =  FilteringBeerMethodReferenceComposing::isFromBelgium;
        Predicate<Beer> expensive =  FilteringBeerMethodReferenceComposing::isExpensive;
        Predicate<Beer> expensiveBelgium = fromBelgium.and(expensive);


        filterBeerCollection(beers, filteredBeers, expensiveBelgium);
